...
export function MainMenu() {
  ...
  return (
    <div className="flex flex-col">
      <div className="sticky top-20 bg-background z-10 flex items-center justify-between px-4 pt-4 pb-2">
            ...
            <AccordionItem key={i} value={`unit-${i}`} className="border-border/50">
              <AccordionTrigger className="text-base font-medium">
                {i === 0 ? (
                  ...
                  <span
                    className="underline"
                    onClick={(e) => { e.stopPropagation(); navigate('/unit/3') }}
                  >
                    {unit.title}
                  </span>
                ) : i === 3 ? (
                  <span
                    className="underline"
                    onClick={(e) => { e.stopPropagation(); navigate('/unit/4') }}
                  >
                    {unit.title}
                  </span>
                ) : unit.title}
